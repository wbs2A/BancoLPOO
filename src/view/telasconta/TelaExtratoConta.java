...
public class TelaExtratoConta {
     ...
     * op��o � o extrato da conta padr�o, caso n�o tenha ser� retornado uma
     * mensagem o informando. A segunda op��o � o extrato de outra conta,onde o
     * usu�rio insere o n�mero e a senha da conta e o programa retorna o extrato
     * desta conta, caso n�o ache o usu�rio � informado.
     */
