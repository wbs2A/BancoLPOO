 ...
 * atulizar dados e excluir conta
 *
...
public class TelaGerenciaPessoa {
	...
	/**
	 * Metodo para impressao da tela para gerenciar dados de cadastro e receber a
	 * opcao que o usuario escolher
	 */
	...
	public static void menuGerenciaPessoas() {
		...
		do {
			try {
				...
				System.out.println("\t\t\t\t**************************************");
				System.out
						.println("\t\t\t\t*   " + MenuPessoa.ATUALIZARDADOS.opcao + ". Atualizar Dados de Cadastro *");
				System.out.println("\t\t\t\t**************************************");
				System.out.println("\t\t\t\t*   " + MenuPessoa.EXLUCIRPESSOA.opcao + ". Excluir Conta *");
				System.out.println("\t\t\t\t**************************************");
				System.out.println(
						"\t\t\t\t*   " + MenuPessoa.VERDADOSPESSOA.opcao + ". Mostrar dados Cadastrados Pessoa *");
				System.out.println("\t\t\t\t**************************************");
