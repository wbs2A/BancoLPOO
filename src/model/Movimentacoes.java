 ...
 * @author Allison
 * @author Valdenize
 * @author Helmuth Classe que representa as movimentacoes do Banco
 */
...
public class Movimentacoes implements Serializable {
	...
	/**
	 * Metodo toString, retorna algumas das informacoes contidas nos atributos
	 * da classe e outras das classes Pessoa e Conta para simplificar as
	 * informações de Movimentacao ao usuário.
	 * 
	 * @return String
	 */
	@Override
